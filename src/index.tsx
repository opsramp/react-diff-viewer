...
class DiffViewer extends React.Component<ReactDiffViewerProps, ReactDiffViewerState> {
  ...
  private renderDiff = (): JSX.Element[] => {
    ...
    const { lineInformation, diffLines, diffCount } = computeLineInformation(
      oldValue,
      newValue,
      disableWordDiff,
      compareMethod,
    ...
    const extraLines = this.props.extraLinesSurroundingDiff < 0
      ? 0 : this.props.extraLinesSurroundingDiff;
    let skippedLines: number[] = [];

    if (this.props.setCount) {
      this.props.setCount(diffCount);
    }
